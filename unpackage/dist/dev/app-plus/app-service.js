...
(function(vue) {
  ...
  const __easycom_0$4 = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["render", _sfc_render$k], ["__scopeId", "data-v-d31e1c47"], ["__file", "E:/uniappP/uniproject/uni_modules/uni-icons/components/uni-icons/uni-icons.vue"]]);
  ...
  const _sfc_main$k = {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const __returned__ = { props, emits, searchData, inputDone, barHeight, marginRight, handleSearch, textInput, handleBack, computed: vue.computed, ref: vue.ref, get debounce() {
        return debounce;
      }, get useTopFit() {
        return useTopFit;
      } };
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "nav-bar" }, [
      vue.createElementVNode("view", { class: "nav-bar-top" }, [
        vue.createElementVNode(
          "view",
          {
            style: vue.normalizeStyle({ height: $setup.barHeight + "rpx" })
          },
          null,
          4
          /* STYLE */
        ),
        vue.createCommentVNode(" 当组件作为搜索界面使用的时候 "),
        $props.isSearch ? (vue.openBlock(), vue.createElementBlock("view", {
          key: 0,
          class: "return-icon",
        ...
        vue.createElementVNode(
          "view",
          {
            ...
            style: vue.normalizeStyle({ marginRight: $setup.marginRight + "rpx", marginLeft: $props.isSearch ? "20rpx" : "" }),
          ...
          [
            ...
            !$props.isSearch ? (vue.openBlock(), vue.createElementBlock("view", {
              key: 0,
              class: "nav-bar-search-text"
            }, " 输入文章标题进行搜索 ")) : vue.withDirectives((vue.openBlock(), vue.createElementBlock(
              "input",
              {
                key: 1,
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $setup.searchData = $event),
                onInput: _cache[1] || (_cache[1] = (...args) => $setup.textInput && $setup.textInput(...args)),
                onConfirm: $setup.inputDone,
                "confirm-type": "search",
                class: "search-input",
                type: "text",
      ...
      vue.createElementVNode(
        "view",
        {
          style: vue.normalizeStyle({ height: $setup.barHeight + 80 + "rpx" })
        },
        [
  ...
  const __easycom_0$3 = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["render", _sfc_render$j], ["__scopeId", "data-v-9367190c"], ["__file", "E:/uniappP/uniproject/components/NavBar/NavBar.vue"]]);
  var isVue2 = false;
...
This will fail in production if not fixed.`);
  ...
  const useUserStore = defineStore("user", {
    ...
    actions: {
      ...
      pushUserPreferenceSet(id) {
        const item = this.labelList.find((item2) => item2._id === id);
  ...
  const _sfc_main$j = {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const __returned__ = { isLogin, props, emit, handleTabItemClick, clickLabelAdmin, ref: vue.ref, get useUserStore() {
        return useUserStore;
      } };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
      ...
      vue.createElementVNode("scroll-view", {
        ...
        vue.createElementVNode("view", { class: "tab-scroll-box" }, [
          (vue.openBlock(true), vue.createElementBlock(
            vue.Fragment,
            null,
            vue.renderList($props.labelList, (item, index) => {
              return vue.openBlock(), vue.createElementBlock("view", {
                class: vue.normalizeClass(["tab-scroll-item", { active: $props.activeIndex === index }]),
                key: index,
                onClick: ($event) => $setup.handleTabItemClick(index)
  ...
  const __easycom_1$4 = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["render", _sfc_render$i], ["__scopeId", "data-v-e632d448"], ["__file", "E:/uniappP/uniproject/components/TabBar/TabBar.vue"]]);
  const _sfc_main$i = {
    __name: "Start",
    props: {
      heartType: {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const __returned__ = { props, isLogin, emits, handleStart, get useUserStore() {
        return useUserStore;
      } };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
  ...
  function _sfc_render$h(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", {
      class: "start-icon",
      onClick: vue.withModifiers($setup.handleStart, ["stop"])
    }, [
      vue.createVNode(_component_uni_icons, {
        color: "#0077FF",
        type: $props.heartType,
        size: "20"
      }, null, 8, ["type"])
    ]);
  }
  const __easycom_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["render", _sfc_render$h], ["__file", "E:/uniappP/uniproject/components/Start/Start.vue"]]);
  const pages = [
    {
...
详细信息：${s4}`), r3(i3);
  ...
  async function userGetCode(phone) {
    uni.showToast({ icon: "none" });
    await Ys.callFunction({
      name: "user_get_code",
      data: phone
    });
  }
  ...
  const _sfc_main$h = {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const __returned__ = { startsIds, userId, props, isInUserStarts, emits, handleClickCard, handleStart, get userUpdateStarts() {
        return userUpdateStarts;
      }, get useUserStore() {
        return useUserStore;
      }, get storeToRefs() {
        return storeToRefs;
  ...
  function _sfc_render$g(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock(
      ...
      [
        ...
        $props.item.mode === "base" ? (vue.openBlock(), vue.createElementBlock("view", {
          key: 0,
          class: "list-card",
          onClick: $setup.handleClickCard
        }, [
          vue.createElementVNode("view", { class: "list-card-header" }, [
            ...
            vue.createVNode(_component_Start, {
              onClickStart: _cache[0] || (_cache[0] = ($event) => $setup.handleStart($props.item._id)),
              class: "list-card-start",
              heartType: $setup.isInUserStarts($props.item._id) ? "heart-filled" : "heart"
            }, null, 8, ["heartType"])
          ]),
          vue.createElementVNode("view", { class: "list-card-content" }, [
            vue.createElementVNode("image", {
              class: "list-card-image",
              src: $props.item.cover[0] ? $props.item.cover[0] : "/static/logo.png",
              mode: "aspectFill"
            }, null, 8, ["src"]),
            vue.createElementVNode(
              "view",
          ...
          vue.createElementVNode("view", { class: "list-card-footer" }, [
            vue.createElementVNode(
              "view",
              { class: "list-card-tag" },
              vue.toDisplayString($props.item.tag),
              1
              /* TEXT */
            ),
            vue.createElementVNode("view", { class: "list-card-publish-time" }, [
              ...
              vue.createElementVNode(
                "view",
                { class: "publish-time" },
                "发布时间：" + vue.toDisplayString($props.item.create_time),
                1
                /* TEXT */
              )
            ]),
            vue.createElementVNode("view", { class: "list-card-browse-count" }, [
              ...
              vue.createElementVNode(
                "view",
                { class: "borws-count" },
                vue.toDisplayString($props.item.browse_count) + "浏览",
                1
                /* TEXT */
              )
            ])
        ...
        $props.item.mode === "mutiple" ? (vue.openBlock(), vue.createElementBlock("view", {
          key: 1,
          ...
          vue.createElementVNode("view", { class: "list-card-header" }, [
            ...
            vue.createVNode(_component_Start, {
              onClickStart: _cache[1] || (_cache[1] = ($event) => $setup.handleStart($props.item._id)),
              class: "list-card-start",
              heartType: $setup.isInUserStarts($props.item._id) ? "heart-filled" : "heart"
            }, null, 8, ["heartType"])
          ]),
          vue.createElementVNode("view", { class: "list-card-content" }, [
            (vue.openBlock(true), vue.createElementBlock(
              vue.Fragment,
              null,
              vue.renderList($props.item.cover, (it2, index) => {
        ...
        $props.item.mode === "cover" ? (vue.openBlock(), vue.createElementBlock("view", {
          key: 2,
          ...
          vue.createElementVNode("view", { class: "list-card-header" }, [
            ...
            vue.createVNode(_component_Start, {
              onClickStart: _cache[2] || (_cache[2] = ($event) => $setup.handleStart($props.item._id)),
              class: "list-card-start",
              heartType: $setup.isInUserStarts($props.item._id) ? "heart-filled" : "heart"
            }, null, 8, ["heartType"])
          ]),
  ...
  const __easycom_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["render", _sfc_render$g], ["__scopeId", "data-v-37ca02cc"], ["__file", "E:/uniappP/uniproject/components/ListCard/ListCard.vue"]]);
  ...
  const __easycom_1$3 = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render$f], ["__scopeId", "data-v-9245e42c"], ["__file", "E:/uniappP/uniproject/uni_modules/uni-load-more/components/uni-load-more/uni-load-more.vue"]]);
  const _sfc_main$f = {
    __name: "ArticleItem",
    props: {
      aticleList: {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const __returned__ = { props, emits, loadMore, onBeforeMount: vue.onBeforeMount, ref: vue.ref };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
    }
  };
        ...
        [
          vue.createElementVNode("view", { class: "article-list-content" }, [
            (vue.openBlock(true), vue.createElementBlock(
              vue.Fragment,
              null,
              vue.renderList($props.aticleList, (item, index) => {
                return vue.openBlock(), vue.createBlock(_component_ListCard, {
                  onSaveSearchHistory: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("saveSearchHistory")),
                  item,
                  key: index
                }, null, 8, ["item"]);
              }),
            ...
            vue.createVNode(_component_uni_load_more, { status: $props.loadStatus }, null, 8, ["status"])
          ])
        ],
        32
        /* NEED_HYDRATION */
  ...
  const __easycom_1$2 = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$e], ["__scopeId", "data-v-46d4f33b"], ["__file", "E:/uniappP/uniproject/components/ArticleItem/ArticleItem.vue"]]);
  ...
  const _sfc_main$e = {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const __returned__ = { props, aticleDataList, pageSize, current, totals, loadStatus, emit, swiperChange, loadMoreData, onBeforeMount: vue.onBeforeMount, ref: vue.ref, watch: vue.watch, get getArticleList() {
  ...
  function _sfc_render$d(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_ArticleItem = resolveEasycom(vue.resolveDynamicComponent("ArticleItem"), __easycom_1$2);
          ...
          return vue.openBlock(), vue.createElementBlock("swiper-item", {
            ...
            vue.createElementVNode("view", { class: "swiper-item" }, [
              vue.createVNode(_component_ArticleItem, {
                loadStatus: $setup.loadStatus,
                aticleList: $setup.aticleDataList[$props.activeIndex],
                onLoadMore: $setup.loadMoreData
  ...
  const __easycom_2$2 = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$d], ["__scopeId", "data-v-6335dad8"], ["__file", "E:/uniappP/uniproject/components/ArticleList/ArticleList.vue"]]);
  async function getLabelList() {
    const { result } = await Ys.callFunction({ name: "label_get_list" });
    if (result.code === 200) {
      return result.data;
    } else {
      uni.showToast({
  ...
  const _sfc_main$d = {
    ...
    setup(__props, { expose: __expose }) {
      ...
      vue.onBeforeMount(async () => {
        ...
        const tabBarBak = lodashExports.cloneDeep(tabBar2.value);
        updateLabelList(tabBarBak);
        updateUserPreferenceSet(vue.toRaw(tabBar2.value));
      });
      const indexChange = (index) => {
        activeIndex.value = index;
        const res = tabBar2.value[index];
        classify.value = res.description;
      };
      const __returned__ = { updateUserPreferenceSet, updateLabelList, userPreferenceSet, tabBar: tabBar2, activeIndex, classify, indexChange, onBeforeMount: vue.onBeforeMount, reactive: vue.reactive, ref: vue.ref, toRaw: vue.toRaw, get getLabelList() {
        return getLabelList;
      }, get useUserStore() {
        return useUserStore;
      }, get cloneDeep() {
        return lodashExports.cloneDeep;
      } };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
    }
  ...
  function _sfc_render$c(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    const _component_ArticleList = resolveEasycom(vue.resolveDynamicComponent("ArticleList"), __easycom_2$2);
    return vue.openBlock(), vue.createElementBlock("view", { class: "home-container" }, [
      ...
      vue.createVNode(_component_TabBar, {
        ...
        labelList: $setup.tabBar,
        onActiveIndexchange: $setup.indexChange
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$c], ["__scopeId", "data-v-1cf27b2a"], ["__file", "E:/uniappP/uniproject/pages/index/index.vue"]]);
  const _sfc_main$c = {
    data() {
      return {};
    },
  ...
  const PagesStartStart = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$b], ["__file", "E:/uniappP/uniproject/pages/start/start.vue"]]);
  const _sfc_main$b = {
    data() {
      return {};
    },
  ...
  const PagesUserUser = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$a], ["__file", "E:/uniappP/uniproject/pages/user/user.vue"]]);
  ...
  const _sfc_main$a = {
    ...
    setup(__props, { expose: __expose }) {
      __expose();
      const searchRes = vue.ref([]);
      const isShowNoData = vue.computed(() => searchRes.value.length);
      const parentValue = vue.ref("");
      const isShowHistory = vue.ref(true);
      ...
      const __returned__ = { searchRes, isShowNoData, parentValue, isShowHistory, searchHistoryList, updateUserSearchHistoryList, clearUserSearchHistoryList, childInputDone, saveSearchHistory, computed: vue.computed, ref: vue.ref, get getSearchData() {
  ...
  function _sfc_render$9(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "search-container" }, [
      vue.createVNode(_component_NavBar, {
        isSearch: true,
        parentValue: $setup.parentValue,
        onChildInputDone: $setup.childInputDone
      }, null, 8, ["parentValue"]),
      vue.createCommentVNode(" 搜索容器 "),
      vue.createCommentVNode(" 没有进行搜索操作 "),
      !$setup.isShowNoData ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 0,
        class: "search-history-container"
      }, [
        vue.createElementVNode("view", { class: "search-header" }, [
          vue.createElementVNode("text", { class: "history-text" }, "搜索历史"),
          vue.createElementVNode("text", {
            class: "clear-history",
            onClick: _cache[0] || (_cache[0] = (...args) => $setup.clearUserSearchHistoryList && $setup.clearUserSearchHistoryList(...args))
          }, "清空")
        ]),
        vue.createElementVNode("view", { class: "search-history-content" }, [
          (vue.openBlock(true), vue.createElementBlock(
            vue.Fragment,
            null,
            vue.renderList($setup.searchHistoryList, (item, index) => {
              return vue.openBlock(), vue.createElementBlock("view", {
                class: "history-tag-item",
                key: index,
                onClick: ($event) => $setup.childInputDone(item)
      ...
      vue.createElementVNode("view", { class: "search-list-container" }, [
        $setup.isShowNoData ? (vue.openBlock(), vue.createElementBlock("view", {
          key: 0,
          class: "search-content"
        }, [
          vue.createVNode(_component_ArticleItem, {
            onSaveSearchHistory: $setup.saveSearchHistory,
            aticleList: $setup.searchRes
          }, null, 8, ["aticleList"])
          ...
          vue.createElementVNode("view", { class: "info" }, "无数据")
        ]))
      ])
    ]);
  }
  const PagesSearchSearch = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$9], ["__file", "E:/uniappP/uniproject/pages/search/search.vue"]]);
  const _sfc_main$9 = {
    __name: "PageHeader",
    props: {
      info: String
    ...
    setup(__props, { expose: __expose }) {
      ...
      const props = __props;
      const __returned__ = { barHeight, handleBack, props, get useTopFit() {
        return useTopFit;
      } };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
      ...
      vue.createElementVNode("view", { class: "header" }, [
        ...
        vue.createElementVNode("view", { class: "header-content" }, [
          ...
          vue.createElementVNode(
            "view",
            { class: "info" },
            vue.toDisplayString($props.info),
            1
            /* TEXT */
          )
        ])
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$8], ["__scopeId", "data-v-5b4cc82c"], ["__file", "E:/uniappP/uniproject/components/PageHeader/PageHeader.vue"]]);
  ...
  const __easycom_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$7], ["__scopeId", "data-v-09fd5285"], ["__file", "E:/uniappP/uniproject/uni_modules/uni-easyinput/components/uni-easyinput/uni-easyinput.vue"]]);
  const _sfc_main$7 = {
    name: "uniFormsItem",
    options: {
      virtualHost: true
  ...
  const __easycom_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__scopeId", "data-v-462874dd"], ["__file", "E:/uniappP/uniproject/uni_modules/uni-forms/components/uni-forms-item/uni-forms-item.vue"]]);
  ...
  const _sfc_main$6 = {
    ...
    setup(__props, { expose: __expose }) {
      __expose();
      const isTimeout = vue.ref(true);
      const props = __props;
      let timer = null;
      const counter = vue.ref(TIMEOUT);
      const getCode = async () => {
      ...
      const __returned__ = { MS_1, TIMEOUT, isTimeout, props, get timer() {
        return timer;
      }, set timer(v2) {
        timer = v2;
      }, counter, getCode, runTime, ref: vue.ref, get validatePhone() {
  ...
  function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "code-container" }, [
      vue.createElementVNode(
        ...
        vue.toDisplayString($setup.isTimeout ? "获取验证码" : $setup.counter + "s"),
        1
        /* TEXT */
      )
    ]);
  }
  const __easycom_3 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__scopeId", "data-v-969c3c07"], ["__file", "E:/uniappP/uniproject/components/SendCode/SendCode.vue"]]);
  var pattern = {
    email: /^\S+?@\S+?\.\S+?$/,
  ...
  const __easycom_4 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__scopeId", "data-v-9a1e3c32"], ["__file", "E:/uniappP/uniproject/uni_modules/uni-forms/components/uni-forms/uni-forms.vue"]]);
  ...
  const _sfc_main$4 = {
    ...
    setup(__props, { expose: __expose }) {
      ...
      const __returned__ = { loginFormRef, barHeight, type, updateUserInfo, formData, handleBack, handleLogin, get rules() {
        return rules;
      }, computed: vue.computed, ref: vue.ref, get delay() {
        return delay;
      }, get useTopFit() {
        return useTopFit;
      }, get onReady() {
      ...
      vue.createElementVNode("view", { class: "login-content" }, [
        vue.createElementVNode("view", { class: "login-tab" }, [
          vue.createElementVNode(
            "view",
            {
              class: vue.normalizeClass(["tab-item", { active: $setup.type === "account" }]),
              onClick: _cache[0] || (_cache[0] = ($event) => $setup.type = "account")
            },
            "账号登录",
            2
            /* CLASS */
          ...
          vue.createElementVNode(
            ...
            {
              class: vue.normalizeClass(["tab-item", { active: $setup.type !== "account" }]),
              onClick: _cache[1] || (_cache[1] = ($event) => $setup.type = "phone")
            },
            "手机登录",
            2
            /* CLASS */
        ...
        vue.createElementVNode("view", { class: "login-form" }, [
          vue.createVNode(_component_uni_forms, {
            ...
            default: vue.withCtx(() => [
              ...
              $setup.type === "account" ? (vue.openBlock(), vue.createElementBlock("view", { key: 0 }, [
                vue.createVNode(_component_uni_forms_item, {
                  ...
                  default: vue.withCtx(() => [
                    vue.createVNode(_component_uni_easyinput, {
                      class: "form-input",
                      modelValue: $setup.formData.account,
                    ...
                    vue.createVNode(_component_uni_forms_item, {
                      ...
                      default: vue.withCtx(() => [
                        vue.createVNode(_component_uni_easyinput, {
                          class: "form-input",
                          type: "text",
                          modelValue: $setup.formData.vcode,
                          "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => $setup.formData.vcode = $event),
                          placeholder: "请输入验证码",
                          trim: "all"
                        }, null, 8, ["modelValue"]),
                        vue.createVNode(_component_SendCode, {
                          phoneForm: $setup.formData,
                          class: "vcode"
                        }, null, 8, ["phoneForm"])
                      ]),
                      _: 1
  ...
  const PagesUserinfoLoginLogin = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__scopeId", "data-v-47d7a160"], ["__file", "E:/uniappP/uniproject/pages/userinfo/login/login.vue"]]);
  const _sfc_main$3 = {
    __name: "Tag",
    props: {
      labelItem: {
    ...
    setup(__props, { expose: __expose, emit: __emit }) {
      ...
      const __returned__ = { props, emits, handleClickClose, handleClickAdd };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
    }
  };
  function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_uni_icons = resolveEasycom(vue.resolveDynamicComponent("uni-icons"), __easycom_0$4);
    return vue.openBlock(), vue.createElementBlock("view", { class: "tag-container" }, [
      vue.createElementVNode(
        "view",
        { class: "info" },
        vue.toDisplayString($props.labelItem.description),
        1
        /* TEXT */
      ),
      $props.isShowClose ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 0,
        class: "operation-icon",
        onClick: $setup.handleClickClose
      }, [
        vue.createVNode(_component_uni_icons, {
          type: "clear",
          color: "red",
      ...
      $props.isShowAdd ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 1,
        class: "operation-icon",
        onClick: $setup.handleClickAdd
      }, [
        vue.createVNode(_component_uni_icons, {
          type: "plus-filled",
          color: "green",
  ...
  const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__scopeId", "data-v-36dd27f3"], ["__file", "E:/uniappP/uniproject/components/Tag/Tag.vue"]]);
  const _sfc_main$2 = {
    __name: "Empty",
    props: {
      height: {
  ...
  function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_uni_icons = resolveEasycom(vue.resolveDynamicComponent("uni-icons"), __easycom_0$4);
    return $props.isShow ? (vue.openBlock(), vue.createElementBlock(
      "view",
      {
        key: 0,
      ...
      [
        ...
        vue.createElementVNode("view", { class: "text" }, " 当前没有数据 ")
      ],
      4
      /* STYLE */
    )) : vue.createCommentVNode("v-if", true);
  }
  const __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__scopeId", "data-v-10231f6d"], ["__file", "E:/uniappP/uniproject/components/Empty/Empty.vue"]]);
  const _sfc_main$1 = {
    __name: "labelAdmin",
    setup(__props, { expose: __expose }) {
      __expose();
      ...
      const labelsDiff = vue.computed(() => labelList.value.filter((item) => !userPreferenceSet.value.some((it2) => it2._id === item._id)));
      const isEdit = vue.ref(false);
      const isShowRecoment = vue.computed(() => labelsDiff.value.length === 0);
      ...
      const __returned__ = { userPreferenceSet, labelList, popUserPreferenceSet, pushUserPreferenceSet, labelsDiff, isEdit, isShowRecoment, handleClose, handleAdd, computed: vue.computed, ref: vue.ref, get useUserStore() {
        return useUserStore;
      }, get storeToRefs() {
        return storeToRefs;
      } };
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_PageHeader = resolveEasycom(vue.resolveDynamicComponent("PageHeader"), __easycom_0);
    const _component_Tag = resolveEasycom(vue.resolveDynamicComponent("Tag"), __easycom_1);
    const _component_Empty = resolveEasycom(vue.resolveDynamicComponent("Empty"), __easycom_2);
    return vue.openBlock(), vue.createElementBlock("view", { class: "label-admin-container" }, [
      vue.createVNode(_component_PageHeader, { info: "标签管理" }),
      vue.createElementVNode("view", { class: "label-admin-my label-admin-block" }, [
        vue.createElementVNode("view", { class: "block-header" }, [
          vue.createElementVNode("text", null, "我的标签"),
          vue.createElementVNode(
            "text",
            {
              class: "edit-txt",
              onClick: _cache[0] || (_cache[0] = () => $setup.isEdit = !$setup.isEdit)
            },
            vue.toDisplayString($setup.isEdit ? "完成" : "编辑"),
            1
            /* TEXT */
          )
        ]),
        vue.createElementVNode("view", { class: "tag-content" }, [
          (vue.openBlock(true), vue.createElementBlock(
            vue.Fragment,
            null,
            vue.renderList($setup.userPreferenceSet, (item) => {
              return vue.openBlock(), vue.createElementBlock("view", {
                class: "tag",
                key: item._id
              }, [
                vue.createVNode(_component_Tag, {
                  isShowClose: $setup.isEdit,
                  onClose: $setup.handleClose,
                  labelItem: item
                }, null, 8, ["isShowClose", "labelItem"])
              ]);
            }),
            128
            /* KEYED_FRAGMENT */
        ...
        vue.createVNode(_component_Empty, { isShow: false })
      ]),
      vue.createElementVNode("view", { class: "label-admin-recoment label-admin-block" }, [
        vue.createElementVNode("view", { class: "block-header" }, [
        ...
        vue.createElementVNode("view", { class: "tag-content" }, [
          (vue.openBlock(true), vue.createElementBlock(
            vue.Fragment,
            null,
            vue.renderList($setup.labelsDiff, (item) => {
              return vue.openBlock(), vue.createElementBlock("view", {
                class: "tag",
                key: item._id
              }, [
                vue.createVNode(_component_Tag, {
                  isShowAdd: $setup.isEdit,
                  labelItem: item,
                  onAdd: $setup.handleAdd
                }, null, 8, ["isShowAdd", "labelItem"])
              ]);
            }),
            128
            /* KEYED_FRAGMENT */
        ...
        vue.createVNode(_component_Empty, { isShow: $setup.isShowRecoment }, null, 8, ["isShow"])
      ])
    ]);
  }
  const PagesLabelAdminLabelAdmin = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__scopeId", "data-v-74db08cf"], ["__file", "E:/uniappP/uniproject/pages/labelAdmin/labelAdmin.vue"]]);
  ...
  __definePage("pages/labelAdmin/labelAdmin", PagesLabelAdminLabelAdmin);
  const _sfc_main = {
    onLaunch: function() {
